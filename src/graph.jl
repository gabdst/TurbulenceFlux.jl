using LinearAlgebra
using SparseArrays
import Graphs: AbstractGraph,edges,edgetype,has_edge,has_vertex,inneighbors,ne,nv,outneighbors,vertices,is_directed,weights,neighbors
...
function generate_weight_mat(adj_mat::SparseMatrixCSC,weight_func::Function;normalize=false)
...
function make_gaussian_kernel(size_Z,vertex_mapping::Function,Σ::AbstractMatrix)
